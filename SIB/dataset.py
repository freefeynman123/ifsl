...
def dataset_setting(dataset, nSupport, image_size=80):
    ...
    if dataset == 'miniImageNet':
        ...
        trainDir = '/nas/people/lukasz_bala/reproducibility/ifsl/downloads/mini_imagenet/train/'
        valDir = '/nas/people/lukasz_bala/reproducibility/ifsl/downloads/mini_imagenet/val/'
        testDir = '/nas/people/lukasz_bala/reproducibility/ifsl/downloads/mini_imagenet/test/'
        episodeJson = '/nas/people/lukasz_bala/reproducibility/ifsl/downloads/mini_imagenet/val1000Episode_5_way_1_shot.json' if nSupport == 1 \
            else '/nas/people/lukasz_bala/reproducibility/ifsl/downloads/mini_imagenet/val1000Episode_5_way_5_shot.json'
    elif dataset == "tiered":
        # mean = [x/255.0 for x in [120.39586422,  115.59361427, 104.54012653]]
        # std = [x/255.0 for x in [70.68188272,  68.27635443,  72.54505529]]
